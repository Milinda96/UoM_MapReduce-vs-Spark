...
output_path = "s3://airline-delay/Year_wise_carrier_delay"
log_file = "Year_wise_carrier_delay_execution.log"
...
with open(log_file, "w") as f:
    for i in range(1, 6):
        ...
        result_df = spark.sql("SELECT _c1 as Year, avg((_c25/_c15)*100) as Year_wise_carrier_delay from delay_flights GROUP BY _c1 ORDER BY _c1 DESC")
